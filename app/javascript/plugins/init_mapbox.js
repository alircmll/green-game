...
const fitMapToMarkers = (map, markers) => {
  ...
  markers.forEach(marker => bounds.extend([ 44.8463,-0.689153 ]));
      ...
      .then((data) => {
        ...
        map.on('load', function () {
          ...
          map.on('click', 'layer-state', function (e) {
            ...
            new mapboxgl.Popup()
              .setLngLat(e.lngLat)
              .setHTML('<h6>'+commune+'</h6>'+'<strong> Jour(s) de collecte:</strong>'+'<br>'+ collect +'<br>'+'<strong>Type:</strong>'+'<br>'+ type)
              .addTo(map);
          });
          ...
          map.addLayer({
            ...
            "paint": {
              "fill-color": "#60365e",
              "fill-opacity": ["case",
              ["boolean", ["feature-state", "hover"], false],1,0.4]
            }
          });
